...
export interface MainMenu_shop_navigation_main_items_emwcategory {
...
export interface MainMenu_shop_navigation_main_items_children_emwcategory {
  __typename: "EMWCategory";
  id: string;
  name: string;
}
...
export interface MainMenu_shop_navigation_main_items_children_children_emwcategory {
  __typename: "EMWCategory";
  id: string;
  name: string;
}
...
export interface MainMenu_shop_navigation_main_items_children_children {
  ...
  id: string;
  name: string;
  emwcategory: MainMenu_shop_navigation_main_items_children_children_emwcategory | null;
  url: string | null;
...
export interface MainMenu_shop_navigation_main_items_children {
  ...
  id: string;
  name: string;
  emwcategory: MainMenu_shop_navigation_main_items_children_emwcategory | null;
  url: string | null;
...
export interface MainMenu_shop_navigation_main_items {
  ...
  id: string;
  name: string;
  emwcategory: MainMenu_shop_navigation_main_items_emwcategory | null;
  url: string | null;
