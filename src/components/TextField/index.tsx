  ...
  <div className="input">
    ...
    {msg && <div>
      <span className="pass-hint">
        *Min 8 characters with one special character.
      </span>
    </div>}
    {errors && (
            ...
            return (
              <Box display="flex" className="account-exist-msg">
                ...
                <Box className="account-exist-msg-text">
                  <p>Password does not meet requirements of minimum of 8 characters with one special character</p>
                </Box>
              </Box>
            )
          } else {
            return (
              <p>This field is required to continue</p>)
          }
        })}
      </span>
    )}
